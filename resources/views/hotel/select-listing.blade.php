<x-layout>
    <div class="max-w-4xl mx-auto bg-slate-800 text-white rounded-lg shadow-md p-8">
        ...
        <p class=" mb-8">To get started, select the type of property you want to list on Booking.com</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="border border-gray-200 rounded-sm p-4 hover:border-blue-500 hover:shadow-md transition-all">
                <h3 class="text-lg font-bold mb-4">Hotel, B&Bs & More</h3>
                <img src="{{asset('images/hotel.png')}}" class="w-20 ml-30 mb-4">
                <p class=" mb-2">Properties like hotels, B&Bs, guest houses, hostels, condo hotels, etc.</p>
